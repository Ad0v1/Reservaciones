<?php
// Desactivar la visualización de errores en el navegador web
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($camposFaltantes)) {
        ...
        try {
            ...
            // Registrar/obtener (con verificación de error)
            ...
            <form id="rform" method="post" action="Reserva.php" autocomplete="off">
                ...
                <div id="step3" class="form-step">
                    ...
                    <div class="botones-navegacion">
                        ...
                        <button type="button" onclick="nextStep(4)">CONFIRMAR SOLICITUD DE RESERVA</button>
                    </div>
                </div>
            </form>
